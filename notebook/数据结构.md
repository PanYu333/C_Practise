...
- **横向先遍历，然后按层次遍历。**从根节点往下，对每一层依此访问，在每一层中从左到右（也可以从右到左）遍历，遍历完一层就进入下一层，直到没有节点。

**深度优先：**

- 前序遍历，访问节点顺序：根节点--->左子节点--->右子节点（根节点在最**前面**被访问）

- 中序遍历，访问节点顺序：左子节点--->根节点--->右子节点（根节点在最**中间**被访问）

- 后续遍历，访问节点顺序：左子节点--->右子节点--->根节点（根节点在最**后面**被访问）
